...
namespace Pizza_Calculator
{
    ...
    public class CompareActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
           ...
           sel_no_edge = Resources.GetText(Resource.String.sel_no_edge);
            ...
            void Chart_SelectionChanged(object sender, SfChart.SelectionChangedEventArgs e)
            {
                ...
                if (e.P1.SelectedDataPointIndex > -1)
                {
                    ...
                    {
                        primaryAxisArea.Title.Text = pizza_sel + number.ToString() + pizza_x_q + pizza[index].Quantity.ToString() + pizza_x_d + pizza[index].diameterNoEdge.ToString();
                    }
                    else
                    {
            ...
            void Chart_SelectionChangedchartPriceToArea(object sender, SfChart.SelectionChangedEventArgs e)
            {
                ...
                if (e.P1.SelectedDataPointIndex > -1)
                {
                    ...
                    if (pizza[index].diameterNoEdge > 0)
                    {
                        primaryAxisPriceToArea.Title.Text = pizza_sel + number.ToString() + pizza_x_d + pizza[index].diameterNoEdge.ToString() + pizza_x_p + pizza[index].price.ToString();
                    }
                    else
                    {
                        primaryAxisPriceToArea.Title.Text = pizza_sel + number.ToString() + pizza_x_d + pizza[index].diameter.ToString() + pizza_x_p + pizza[index].price.ToString();  
                    }
            ...
            void Chart_SelectionChangedchartPriceToWeight(object sender, SfChart.SelectionChangedEventArgs e)
            {
                ...
                if (e.P1.SelectedDataPointIndex > -1)
                {
                    ...
                    {
                        primaryAxisPriceToWeight.Title.Text = pizza_sel + number.ToString() + pizza_x_p + pizza[index].price.ToString() + pizza_x_w + pizza[index].weightNoEdge.ToString();
                    }
                    else
                    {
